...
'This business class for a registering college student calculates the sememster costs for tuition. It also causes
'the student costs file to be written.
...
Public Class Student
    ...
    Sub New(ByVal strStudentID As String, ByVal strStudentName As String, ByVal strMajor As String, ByVal intUnits As String)
        ...
        'The following code assigns the aruments to class variables.
    ...
    Overridable Function ComputeCosts() As Decimal
        'This function computes the registration costs, writes a record in the student costs file,
        'and returns the registration costs.
